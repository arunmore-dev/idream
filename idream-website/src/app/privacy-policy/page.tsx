...
import styles from "@/components/LegalPage/LegalPage.module.css";
    ...
    >
      ...
      <section id="data-usage">
        ...
        <ul className={styles.listBlock}>
          <li className={styles.listItem}>
            <strong>Service delivery</strong> — provisioning accounts, processing transactions, generating reports and tax summaries, and sending account notifications.
          </li>
          <li className={styles.listItem}>
            <strong>Legal compliance</strong> — meeting obligations under the Companies Act 2006, HMRC Making Tax Digital requirements, and Anti-Money Laundering regulations.
          </li>
          <li className={styles.listItem}>
            <strong>Product improvement</strong> — analysing aggregated usage patterns to prioritise features and resolve bugs, using anonymised data wherever possible.
          </li>
          <li className={styles.listItem}>
            <strong>Security</strong> — detecting fraudulent logins, monitoring for platform abuse, and maintaining audit logs for up to 12 months.
          </li>
          <li className={styles.listItem}>
            <strong>Communications</strong> — sending transactional emails, product digests (opt-out available), and occasional feedback surveys.
          </li>
        </ul>
      ...
      <section id="gdpr-rights">
        ...
        <ul className={styles.listBlock}>
          ...
          <li className={styles.listItem}>
            <strong>Right to erasure</strong> — request deletion where there is no overriding legal basis to retain it.
          </li>
          <li className={styles.listItem}>
            <strong>Right to restriction</strong> — ask us to pause processing while a complaint is investigated.
          </li>
          <li className={styles.listItem}>
        ...
        <p>
          ...
          our response, you may complain to the <a href="https://ico.org.uk/" target="_blank" rel="noopener noreferrer">Information Commissioner&apos;s Office (ICO)</a> in the UK,
